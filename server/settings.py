...
class Settings:
    ...
    Every missing variable is reported at once. Failing on the first one means a
    misconfigured deployment is fixed one redeploy at a time, and each round trip
    is a minute you spend finding out there was another one behind it."""
    ...
    def __init__(self) -> None:
        ...
        self.supabase_url = require("SUPABASE_URL").rstrip("/")
